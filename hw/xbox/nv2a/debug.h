...
#define NV2A_PROF_COUNTERS_XMAC \
    ...
    _X(NV2A_PROF_TEX_BIND_CHECK) \
    _X(NV2A_PROF_TEX_BIND_CLEAN) \
    _X(NV2A_PROF_TEX_BIND_REUSE) \
    _X(NV2A_PROF_TEX_DIRTY_PAGE_TEST) \
    _X(NV2A_PROF_TEX_DIRTY_PAGE_HIT) \
    _X(NV2A_PROF_TEX_SURFACE_SYNC_CHECK) \
    _X(NV2A_PROF_TEX_HASH) \
    _X(NV2A_PROF_TEX_HASH_UNCHANGED) \
    _X(NV2A_PROF_TEX_CACHE_MISS) \
